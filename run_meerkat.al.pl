...
my $pre_process = "$meerkat_home/pre_process2_0.044.pl";
my $meerkat = "$meerkat_home/meerkat_0.175.pl";
my $rmEmptyFqs = "$meerkat_home/rmEmptyFqs.pl";
my $bwaLogCreate = "$meerkat_home/bwa_log_create.pl";
my $generateBlacklist = "$meerkat_home/generateBlacklist.pl";
